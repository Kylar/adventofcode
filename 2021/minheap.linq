...
//	}
	...
	public T RemoveMin()
	{
		...
		{
			int min = c;
			if (2 * c + 1 < array.Count && array[2 * c + 1].CompareTo(array[min]) < 0)
				min = 2 * c + 1;
			if (2 * c + 2 < array.Count && array[2 * c + 2].CompareTo(array[min]) < 0)
				min = 2 * c + 2;
